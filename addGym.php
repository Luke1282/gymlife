...
$sql10 = "INSERT INTO gyms VALUES ($gym_ID, '$gym_name', '$address', '$city', '$post_code', '$openTimes', '$description')";
...
<div class="header">
  <h1>Click next to enter Membership Options</h1><br><br><br><br>
</div>
<form action = "membReg.php">
